          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <motion.button
                ...
                className="flex items-center gap-3 px-3 py-1.5 bg-amber-400 text-slate-950 rounded-full font-semibold hover:shadow-[0_0_30px_rgba(251,191,36,0.35)] transition-all"
              >
                <span className="w-8 h-8 bg-black rounded-full flex items-center justify-center text-amber-400">
                  →
                </span>
                Book a Call
              </motion.button>
          ...
          >
            <div className="py-4 space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-2 bg-gradient-to-r from-amber-500 to-yellow-500 text-slate-950 rounded-full font-semibold hover:shadow-[0_0_30px_rgba(251,191,36,0.35)] transition-all"
              >
                Book a Call →
              </button>
            </div>
